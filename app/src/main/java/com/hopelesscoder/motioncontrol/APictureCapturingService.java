...
public abstract class APictureCapturingService {
     ...
     *
     * @param listener picture capturing listener
     * @param backCamera true if you want to take a picture only from the back camera
     *
     * @author hopelesscoder (pasqdaniele@gmail.com)
     */
    public abstract void startCapturing(PictureCapturingListener listener, boolean backCamera);
}